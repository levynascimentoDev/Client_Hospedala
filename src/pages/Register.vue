  ...
  <div class="container">
    <section>
      <div class="register">
        ...
        <h1 style="user-select: none;">Cadastro</h1>
        ...
        <ButtonAuthGoogle :isLogin="false" ref="googleButton" @load="processing"/>
    ...
    async requestAuth() {
      try {
        ...
        if (response.ok) {
          ...
          return this.router.push(`/auth/checkout/register/${values.token}`);
        } 
      } catch (err) {
        console.error(err);
      } finally {
